...
class LogService:
    def __init__(self):
        ...
        self.enable_error_email = config.ENABLE_ERROR_EMAIL
    ...
    def send_error_email(self, log_entry):
        from services.email_service import send_email  # Adjust the import
        subject = "Error Log Notification"
        body = f"Error log entry:\n{log_entry}"
        send_email(self.admin_emails, subject, body)
